        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: '0.75rem' }}>
              <a href="https://www.instagram.com/festaevents_sn/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" style={socialStyle}>
                <Instagram size={18} />
              </a>
              <a href="https://www.tiktok.com/@festa_events" target="_blank" rel="noopener noreferrer" aria-label="TikTok" style={socialStyle}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 0 0-.79-.05 6.34 6.34 0 0 0-6.34 6.34 6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.33-6.34V8.69a8.18 8.18 0 0 0 4.78 1.52V6.76a4.85 4.85 0 0 1-1.01-.07z"/>
                </svg>
              </a>
              <a href="https://www.facebook.com/festaeventssn/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" style={socialStyle}>
                <Facebook size={18} />
              </a>
            </div>
          </div>
